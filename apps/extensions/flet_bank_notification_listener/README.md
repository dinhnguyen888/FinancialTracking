# flet-bank-notification-listener

flet-bank-notification-listener [Flet](https://flet.dev) extension.
...
Add `flet-bank-notification-listener` dependency to the `pyproject.toml` of your Flet project:

* **From Git**

```toml
dependencies = [
  "flet-bank-notification-listener @ git+https://github.com/MY_GITHUB_ACCOUNT/flet-bank-notification-listener",
  "flet>=1.0.0",
]
```
...
Detailed documentation for this package can be found [here](https://MY_GITHUB_ACCOUNT.github.io/flet-bank-notification-listener/).
